...
import { Trophy, Target, TrendingUp, Flame, Shield, ArrowUpCircle, ArrowDownCircle, Clock, Star, Lock, Crown, Crosshair, Swords, BarChart2, Percent, Users, Activity, Disc, AlertTriangle, Timer } from "lucide-react";
    ...
    <div className="px-4 pb-24">
      ...
      {isLoading ? (
        ...
        <>
          ...
          {(() => {
            const scoringCards = [
              { key: "goals", label: "Goals", icon: Disc, color: "text-red-400" },
          ...
          {(() => {
            const advancedCards = [
              ...
              { key: "power_play_goals", label: "PPG", icon: Trophy, color: "text-violet-400", value: totalPPG },
              { key: "power_play_points", label: "PPP", icon: TrendingUp, color: "text-violet-400", value: totalPPP },
              { key: "shorthanded_goals", label: "SHG", icon: Trophy, color: "text-amber-400", value: totalSHG },
              { key: "shorthanded_points", label: "SHP", icon: TrendingUp, color: "text-amber-400", value: totalSHP },
