  ...
  return (
    <div className={cardClasses}>
      ...
      <div className="my-6 flex items-baseline gap-2">
        ...
        <span className="text-[14px] text-foreground/70">/mo</span>
      </div>

      <div className="w-full mb-5 h-px bg-gradient-to-r from-transparent via-black/10 to-transparent dark:via-white/20" />
      ...
      <RippleButton className={buttonClasses} onClick={onButtonClick}>
        {buttonText}
      </RippleButton>
    </div>
  );
